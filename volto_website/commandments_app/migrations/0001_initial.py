    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Salvation', 'Salvation commands'), ('Discipleship', 'Discipleship Commands'), ('EffectiveWorship', 'Effective worship commands'), ('Blessings', 'Blessings'), ('JudgmentSeat', 'Judgment Seat and Rewards commands'), ('Relationship', 'Relationship Commands'), ('Marriage', 'Marriage commands'), ('Persecution', 'Persecution Commands'), ('HowToBe', 'How to Be, Do or Think commands'), ('EthicOfLove', 'Ethic of Love'), ('Prayer', 'Prayer Commands'), ('FalseTeachers', 'False Teachers Commands'), ('Evangelism', 'Evangelism and Missions'), ('Greatest', 'Greatest Commands'), ('Finance', 'Finance Commands'), ('EndTimes', 'End Times')], default=commandments_app.models.CommandmentCategories('Salvation commands'), max_length=32)),
            ],
        ),
        migrations.CreateModel(
            name='Song',
